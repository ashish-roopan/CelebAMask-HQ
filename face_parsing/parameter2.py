...
def get_parameters():
    ...
    parser.add_argument('--test_image_path', type=str, default='/content/CelebAMask-HQ/pipeline/data/frames') 
    parser.add_argument('--test_label_path', type=str, default='/content/CelebAMask-HQ/pipeline/data/mask') 
    parser.add_argument('--test_color_label_path', type=str, default='/content/CelebAMask-HQ/pipeline/data/mask_color') 
